const paragraphs = [
    ...
    "The greatest wealth is our own health. A healthy body can earn great wealth but, a wealthy person cannot earn great health. We live in a fast-moving world where individuals have no time for themselves. Most part of their life withers away in search of materialistic. ",
    ...
    "There is truth in the common saying: “Cleanliness is next to godliness.” It is a great virtue. It makes a man healthy and happy. The healthy habit of cleanliness should be formed from childhood in our everyday routine. A clean environment keeps us free from pollution. ",
    "Contamination of water bodies because of the discharge of pollutants into them is known as water pollution. Water pollution may severely affect human, plant, and animal life. Pathogens are disease-causing bacteria present in wastewater. When contaminated water is consumed. ",
    ...
    "My favourite hobby is gardening. I started it when I was only ten. I dig the land, sow the seeds, and water the plants in my garden. Every afternoon I work for an hour in my garden and watch the buds come up and the branches nod in the breeze. Although a hobby is a source of. ",
    "The newspaper is the mirror of the world. It plays a vital role in modern civilization. In our country newspapers are published in many languages. It helps us to acquire general knowledge. Newspapers provide reports, speeches, reviews on trade and commerce, films, sports. ",
    "Television is a great gift of science. It offers double the benefits of cinema and radio. Television is the most important and effective instrument of entertainment. It relays live telecasts of important events. It is also the best medium of advertisement. It helps mass education. ",
    "Of late, sound or noise pollution has adversely affected our normal life in a major way. It is chasing us at almost every step. In schools, colleges, offices, and even hospitals we have an explosion of deafening sound. There are many causes of sound pollution. ",
    ...
    "Emerson's own contributions to this democratic ideal of equality so uniquely American are great. Not many writers can challenge his talent for a brevity of sentence that contains such daring power as this: The simplest person, who in his integrity worships God. ",
    "An idea can transcend time because the soul advances by an ascension of state; we gain a deeper understanding of truth not by anything physical, but through our minds. The greater insight we gain into the spirit that connects everything in our world, the closer. ",
